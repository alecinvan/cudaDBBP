...
void         gpuNeuralNetworkBPtrain(PGconn *conn, string path, string lastRoundWeightPath, string lastRoundWeightFileString,
                                     string inputfile, string testfile, unsigned int slurm_job_id, float u, float alfa,
                                     unsigned int N_input, unsigned int N_1hidden, unsigned int N_2hidden, unsigned int N_output,
                                     unsigned int epochs, unsigned int stage) ;
...
void         gpuBackPropagationCompute(float u, float alfa, unsigned int N_input,
