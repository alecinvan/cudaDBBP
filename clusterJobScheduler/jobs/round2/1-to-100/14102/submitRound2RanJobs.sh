...
for (( c=1; c<=80 ; c++))
do
   echo "srun --gres=gpu:1 14102_round2RandomJobs_file.sh &  "
   srun --gres=gpu:1 14102_round2RandomJobs_file.sh &
##############  srun --gres=gpu:1 -w cuda01 14102_round2RandomJobs_file.sh &
#   sleep 3
